      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 px-4">
                ...
                <div className="flex flex-col grow">
                  ...
                  <div className="flex items-center mt-4">
                    <div className="flex items-center rounded-xl border border-gray-300">
                      <button
                        onClick={() => dispatch(decrementQty(item.id))}
                        className="px-4 py-2 hover:bg-gray-200 transition text-lg font-bold text-gray-800"
                      >
                        −
                      </button>

                      <span className="px-6 py-2 text-lg font-semibold border-l border-r border-gray-300 text-gray-800">
                        {item.quantity}
                      </span>

                      <button
                        onClick={() => dispatch(incrementQty(item.id))}
                        className="px-4 py-2 hover:bg-gray-200 transition text-lg font-bold text-gray-800 border-l border-r border-gray-300"
                      >
                        +
                      </button>
                      ...
                      title="Remove item"
                      onClick={() => dispatch(removeFromCart(item.id))}
                      className=" p-1  text-black rounded-lg  transition flex items-center justify-center hover:scale-105"
                    >
        ...
        <div className="lg:col-span-1">
          ...
          <button className="px-4 py-2 bg-linear-to-r from-pink-500 to-purple-400 text-white  transition">
            ...
            {/* Checkout button */}
            <button onClick={handlePlaceOrder} className="w-full mt-6 bg-linear-to-r from-pink-500 to-purple-400 py-3 rounded-xl text-lg font-semibold  transition">
              Proceed to Checkout
            </button>
          </div>
        </div>
